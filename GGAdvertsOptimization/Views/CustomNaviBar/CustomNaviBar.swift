...
class CustomNaviBar: UIView {
    ...
    var itemColor = #colorLiteral(red: 0.2265408337, green: 0.270888865, blue: 0.3039178252, alpha: 1)/*UIColor(red: 0.22, green: 0.22, blue: 0.19, alpha: 1)*/ {
        didSet{
    ...
    private func commonInit() {
        ...
        addSubview(view)
        backgroundColor = #colorLiteral(red: 0.4352941176, green: 0.8274509804, blue: 0.8352941176, alpha: 1)
    }
    ...
    @IBAction func buttonBack(_ sender: Any) {
        ...
        if let main = AppDelegate.shared.mainTabbarController {
            let vc = (main.subScreenList[main.currentIndexSelected] as? UINavigationController)?.popViewController(animated: true)
            if vc == nil {
                VCService.pop()
            }
        }
